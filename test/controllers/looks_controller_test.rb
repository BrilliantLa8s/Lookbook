...
class LooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create look" do
    assert_difference('Look.count') do
      post looks_url, params: { look: { album_id: @look.album_id, description: @look.description, feedback: @look.feedback, howto: @look.howto, name: @look.name, occasion: @look.occasion, products: @look.products } }
    end
  ...
  test "should update look" do
    patch look_url(@look), params: { look: { album_id: @look.album_id, description: @look.description, feedback: @look.feedback, howto: @look.howto, name: @look.name, occasion: @look.occasion, products: @look.products } }
